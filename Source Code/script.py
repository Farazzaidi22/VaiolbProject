...
# Round 4
    ...
    ######### FOR COLUMN BG Difference to AVERAGE Degree Centrality (social challenge patents)
        ...
        output_dict["Difference to AVERAGE Degree Centrality (social challenge patents)"] += For_Col_BG_and_BH(year, H2020_df, H2020_df_DED51_pub, Network_total_df, 'Total social challenge', code)

    ######### FOR COLUMN BH Difference to AVERAGE Degree Centrality (total patents)

        output_dict["Difference to AVERAGE Degree Centrality (total patents)"] += For_Col_BG_and_BH(year, H2020_df, H2020_df_DED51_pub, Network_total_df, 'Total patents', code)
...
# columns
    output_dict = {
        ...
        'Difference to AVERAGE Degree Centrality (social challenge patents)': [],

        'Difference to highest Degree Centrality (total patents)' : [],
        'Difference to AVERAGE Degree Centrality (total patents)': [],
